# virtual-dsm
```
docker run -itd --name nas --privileged -e RAM_CHECK=N -p 80:5000 -p 6690:6690 -p 22:22 -p 445:445 -p 139:139 --cap-add NET_ADMIN -v /mnt/e/Nas:/storage -e DISK_SIZE=60G -e RAM_SIZE=8G -e CPU_CORES=8 vdsm/virtual-dsm
```
